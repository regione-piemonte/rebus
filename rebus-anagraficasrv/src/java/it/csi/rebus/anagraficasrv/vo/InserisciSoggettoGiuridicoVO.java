...
public class InserisciSoggettoGiuridicoVO extends ParentVO {
	// DATI IDENTIFICATIVI
	...
	public void setDatiBancari(List<DatiBancariVO> datiBancari) {
	 ...
	 public Long getCodCsrBip() { return codCsrBip; }
	 
	 public void setCodCsrBip(Long codCsrBip) { this.codCsrBip = codCsrBip; }
