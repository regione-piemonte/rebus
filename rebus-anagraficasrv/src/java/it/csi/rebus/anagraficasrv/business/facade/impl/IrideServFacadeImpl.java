...
*/
package it.csi.rebus.anagraficasrv.business.facade.impl;
...
import it.csi.rebus.anagraficasrv.common.config.RebusConfig;
...
import it.csi.rebus.anagraficasrv.integration.iride.IdentitaNonAutenticaException;
import it.csi.rebus.anagraficasrv.integration.iride.PolicyEnforcerBaseService;
import it.csi.rebus.anagraficasrv.integration.iride.PolicyEnforcerBaseServiceServiceLocator;
...
public class IrideServFacadeImpl implements IrideServFacade, InitializingBean {
	...
	public String getInfoPersonaInUseCase(Identita identita, String codRuoloCompleto) throws Exception {
		return binding.getInfoPersonaInUseCase(identita, new it.csi.rebus.anagraficasrv.integration.iride.UseCase(null, codRuoloCompleto));
	}
