...
*/
package it.csi.rebus.anagraficasrv.common;
...
public class Messages {
	...
	public final static String UTENTE_NON_AUTORIZATO = "L'utente non risulta autorizzato ad accedere alla risorsa richiesta";
