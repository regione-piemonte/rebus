...
public class UserResource extends SpringSupportedResource {
	...
	@GET
	@Path("/getCodiceRuoloUtente")
	public Response getCodiceRuoloUtente(@Context HttpServletRequest req) {
		return Response.ok().entity(userService.getCodiceRuoloUtente()).header("Access-Control-Allow-Origin", "*")
				.build();
	}
}
