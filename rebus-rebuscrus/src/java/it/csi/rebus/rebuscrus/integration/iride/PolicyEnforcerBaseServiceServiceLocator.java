...
public class PolicyEnforcerBaseServiceServiceLocator extends org.apache.axis.client.Service implements it.csi.rebus.rebuscrus.integration.iride.PolicyEnforcerBaseServiceService {
    ...
    private java.lang.String PolicyEnforcerBase_address = "http://tst-wfexp-vip01.csi.it/pep_wsfad_policy/services/PolicyEnforcerBase";
    ...
    public it.csi.rebus.rebuscrus.integration.iride.PolicyEnforcerBaseService getPolicyEnforcerBase() throws javax.xml.rpc.ServiceException {
    ...
    public it.csi.rebus.rebuscrus.integration.iride.PolicyEnforcerBaseService getPolicyEnforcerBase(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            it.csi.rebus.rebuscrus.integration.iride.PolicyEnforcerBaseSoapBindingStub _stub = new it.csi.rebus.rebuscrus.integration.iride.PolicyEnforcerBaseSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (it.csi.rebus.rebuscrus.integration.iride.PolicyEnforcerBaseService.class.isAssignableFrom(serviceEndpointInterface)) {
                it.csi.rebus.rebuscrus.integration.iride.PolicyEnforcerBaseSoapBindingStub _stub = new it.csi.rebus.rebuscrus.integration.iride.PolicyEnforcerBaseSoapBindingStub(new java.net.URL(PolicyEnforcerBase_address), this);
                _stub.setPortName(getPolicyEnforcerBaseWSDDServiceName());
                return _stub;
            }
        }
